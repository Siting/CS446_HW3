...
//				}
			...
			// print to file
			PrintWriter out = new PrintWriter("exp1_2_output_algo" + algo + ".txt"); 
			for(int i=0; i<cumuError.size(); i++) {
				out.println(cumuError.get(i).get(0) + "," + cumuError.get(i).get(1));
			}
			out.close();
			
			System.out.println("Algorithm " + algo + " has " + cumuE + " mistakes");
